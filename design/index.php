...
<body>
    <div class="container">
        ...
        <section class="scroll-section" id="scroll-section-0">
            ...
            <div class="sticky-elem main-message">
                <p>주변의 맛을 느끼게 해주는<br>주변 맛 허용 모드</p>
            </div>
            <div class="sticky-elem main-message">
                <p>온종일 편안한<br>맞춤형 손잡이</p>
            </div>
            <div class="sticky-elem main-message">
                <p>새로게 입가를<br>찾아온 매혹</p>
            </div>
        </section>
        ...
        <section class="scroll-section" id="scroll-section-2">
            ...
            <div class="sticky-elem desc-message">
                <p>
                    편안한 목넘김을 완성하는 디테일한 여러 구성 요서들, 우리는 이를 하나하나 새롭게 살피고 재구성하는 과정을 거쳐 새로운 수준의 머그, AriMug Pro를 만들었습니다. 입에 뭔가 댔다는 감각은 어느새 사라지고 오롯이 당신과 음료만 남게 되죠.
                </p>
                <div class="pin"></div>
            </div>
            <div class="sticky-elem desc-message">
        ...
        <section class="scroll-section" id="scroll-section-3">
            ...
            <p class="canvas-caption">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti iste libero molestiae perferendis possimus provident reiciendis tempore. Corporis eaque eum neque quas temporibus totam? Accusantium, ad adipisci aliquam aspernatur autem dolor dolores eaque fugiat illum ipsa itaque maiores nemo numquam odio officia quae quas quasi, quidem quod reiciendis sed sequi tempora, ullam. Aliquam aliquid, asperiores aspernatur culpa deleniti doloribus dolorum eaque esse est facere facilis fugit illo impedit laborum magnam maxime minima modi molestiae nam natus nesciunt nisi nobis non nulla obcaecati perspiciatis praesentium quam quibusdam quidem quis quod rem repellendus sit temporibus ut velit vitae. Accusamus quidem voluptate voluptatibus.
            </p>
        </section>
