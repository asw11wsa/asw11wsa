...
<html lang="ko">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="/mincoding/style.css" />
  </head>
  <body>
    <header class="header">
      <div class="global-width">
        ...
        <p>
          ...
          <a href="https://www.bbc.com/korean/resources/idt-48d3c9a7-4063-4289-9726-611b5ea9d7b5"
            target="_blank"
    ...
    <section class="scroll-content">
      <div class="scroll-graphic">
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/00.png" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/01.png" alt="" />
        </div>
        <div class="graphic-item" data-action="birdFlies">
          <img class="bird" src="/asset/image/minutes/bird.gif" alt="" />
          <img class="scene-img" src="/asset/image/minutes/02.png" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/bird.gif" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/03.png" alt="" />
        </div>
        <div class="graphic-item" data-action="birdFlies2">
          <img class="bird" src="/asset/image/minutes/bird.gif" alt="">
          <img class="scene-img" src="/asset/image/minutes/04.png" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/05.png" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/06.png" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/07.png" alt="" />
        </div>
        <div class="graphic-item">
          <img class="scene-img" src="/asset/image/minutes/08.png" alt="" />
        </div>
      </div>
    ...
    <script src="/mincoding/main.js"></script>
  </body>
</html>
